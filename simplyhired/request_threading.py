...
class RequestInfoThread(Thread): 
    ...
    def _request_info(self): 
        ...
        Each job_result will contain a number of features to grab. Grab 
        these, and then its href attribute. Use that href to actually 
        issue a request for the job posting's text. 
